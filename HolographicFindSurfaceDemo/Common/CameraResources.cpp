...
)
{
    ...
    if (viewTransformAcquired)
    {
        ...
        // every frame.
        auto viewLeft = XMLoadFloat4x4(&viewCoordinateSystemTransform.Left);
        auto viewRight = XMLoadFloat4x4(&viewCoordinateSystemTransform.Right);

        XMStoreFloat4x4(
            &viewProjectionConstantBufferData.viewProjection[0],
            XMMatrixTranspose(viewLeft * XMLoadFloat4x4(&cameraProjectionTransform.Left))
        );
        XMStoreFloat4x4(
            &viewProjectionConstantBufferData.viewProjection[1],
            XMMatrixTranspose(viewRight * XMLoadFloat4x4(&cameraProjectionTransform.Right))
        );
        XMStoreFloat4x4(
            &viewProjectionConstantBufferData.viewMatrix[0],
            XMMatrixTranspose(viewLeft)
        );
        XMStoreFloat4x4(
            &viewProjectionConstantBufferData.viewMatrix[1],
            XMMatrixTranspose(viewRight)
        );
    }
