...
namespace HolographicFindSurfaceDemo
{
    ...
    protected:
        ...
        //> Added by CurvSurf
        void OnEnteredBackground(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::ApplicationModel::EnteredBackgroundEventArgs const& args);
        void OnLeavingBackground(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::ApplicationModel::LeavingBackgroundEventArgs const& args);
    ...
    private:
        std::unique_ptr<HolographicFindSurfaceDemoMain> m_main;
        ...
        winrt::event_token                                      m_enteredBackgroundEventToken; // Added by CurvSurf
        winrt::event_token                                      m_leavingBackgroundEventToken; // Added by CurvSurf
