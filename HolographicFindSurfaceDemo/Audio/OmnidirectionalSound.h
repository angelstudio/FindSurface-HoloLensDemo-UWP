...
public:
    ...
    HRESULT Initialize(winrt::Windows::Media::SpeechSynthesis::SpeechSynthesisStream& stream, UINT32 const& loopCount);
    ...
    HRESULT OnUpdate(_In_ winrt::Windows::Foundation::Numerics::float3 transform);
...
private:
    ...
    HRESULT                                     _initStatus = E_NOT_VALID_STATE;
