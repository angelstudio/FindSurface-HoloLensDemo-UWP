...
HRESULT AudioStreamReader::Initialize(SpeechSynthesisStream& speechSynthesisStream)
{
    ...
    //> Update C++/CX to C++/WinRT by CurvSurf
    auto streamUnknown = speechSynthesisStream.as<IUnknown>(); // return winrt::com_ptr<IUnknown>
    ComPtr<IMFByteStream> byteStream;
    if (SUCCEEDED(hr))
    {
        // streamUnknown => A pointer to the IRandomAccessStream interface.
